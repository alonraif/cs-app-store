...
### System Requirements
Windows 10+ or macOS 12+. Network access to the encoder units required.
`,
    category: 'Diagnostics',
...
Exits with code 1 if any certificate is expiring within the threshold — integrates cleanly into CI.
`,
    category: 'Security',
    type: ToolType.cli,
    version: '1.2.0',
...
A web-based metrics explorer pre-configured with LiveU-specific InfluxDB queries. Provides dashboards for video quality, bonding throughput, cloud transcoding latency, and CDN egress costs.
...
### Features
- Define up to 8 virtual interfaces with independent loss / delay / bandwidth
...
- Prevents flashing release units with experimental builds (override with \`--force\`)
`,
    category: 'Automation',
    type: ToolType.desktop,
    version: '5.0.1',
